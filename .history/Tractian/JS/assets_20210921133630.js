const showData = response => {
    ...
    for(const assets in response) {
          ...
          const textoEdit = document.createTextNode("Edit");
          btnEdit.appendChild(textoEdit);
          tdActions.innerHTML = btnEdit.value;
          

          let btnDelete = document.createElement("button");
          btnDelete.classList.add("btn", "btn-danger");
          const textoDelete = document.createTextNode("Delete");
          btnDelete.appendChild(textoDelete);
          tdActions.innerHTML = btnDelete.value;
          tdActions.append(btnEdit, btn);
