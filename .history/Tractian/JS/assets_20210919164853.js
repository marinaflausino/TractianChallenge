const showData = response => {
    ...
    for(const assets in response) {
          ...
          <a href="eye" data-toggle="popover" title="Popover Header" data-content="Some content inside the popover">Toggle popover</a>;headerMetrics.appendChild(iconMetrics);
